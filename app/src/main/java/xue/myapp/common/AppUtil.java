...
public final class AppUtil {
    ...
    public static boolean installAppSilent(String filePath) {
        ...
        ShellUtil.CommandResult commandResult = ShellUtil.execCmd(command, !isSystemApp(MyAPP.getContext()), true);
    ...
    public static void launchApp(String packageName) {
        if (isSpace(packageName)) return;
        MyAPP.getContext().startActivity(IntentUtil.getLaunchAppIntent(packageName));
    }
    ...
    public static boolean cleanAppData(File... dirs) {
        boolean isSuccess = CleanUtil.cleanInternalCache();
        isSuccess &= CleanUtil.cleanInternalDbs();
        isSuccess &= CleanUtil.cleanInternalSP();
        isSuccess &= CleanUtil.cleanInternalFiles();
        isSuccess &= CleanUtil.cleanExternalCache();
        for (File dir : dirs) {
