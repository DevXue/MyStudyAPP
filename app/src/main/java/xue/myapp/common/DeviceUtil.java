...
public final class DeviceUtil {
    ...
    public static String getAndroidID() {
        return Settings.Secure.getString(MyAPP.getContext().getContentResolver(), Settings.Secure.ANDROID_ID);
    }
    ...
    public static void reboot(String reason) {
        PowerManager mPowerManager = (PowerManager) MyAPP.getContext().getSystemService(Context.POWER_SERVICE);
        try {
