...
public final class IntentUtil {
    ...
    public static Intent getInstallAppIntent(File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(MyAPP.getContext(), "com.your.package.fileProvider", file);
    ...
    public static Intent getLaunchAppIntent(String packageName) {
        return MyAPP.getContext().getPackageManager().getLaunchIntentForPackage(packageName);
    }
