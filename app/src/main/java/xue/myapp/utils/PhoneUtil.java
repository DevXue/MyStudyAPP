...
public final class PhoneUtil {
    ...
    public static void dial(String phoneNumber) {
        MyAPP.getContext().startActivity(IntentUtil.getDialIntent(phoneNumber));
    }
    ...
    public static void call(String phoneNumber) {
        MyAPP.getContext().startActivity(IntentUtil.getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(String phoneNumber, String content) {
        MyAPP.getContext().startActivity(IntentUtil.getSendSmsIntent(phoneNumber, content));
    }
    ...
    public static void sendSmsSilent(String phoneNumber, String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(MyAPP.getContext(), 0, new Intent(), 0);
