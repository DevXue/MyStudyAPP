    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && MyAPP.getContext().getExternalCacheDir() != null)
                dir = MyAPP.getContext().getExternalCacheDir() + File.separator + "log" + File.separator;
            else {
                dir = MyAPP.getContext().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
