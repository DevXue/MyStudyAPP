...
import com.dvp.base.util.SDCardUtil;
...
public final class CleanUtil {
    ...
    public static boolean cleanInternalCache() {
        return FileUtil.deleteFilesInDir(MyAPP.getContext().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return FileUtil.deleteFilesInDir(MyAPP.getContext().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return FileUtil.deleteFilesInDir(MyAPP.getContext().getFilesDir().getParent() + File.separator + "databases");
    }
    ...
    public static boolean cleanInternalDbByName( String dbName) {
        return MyAPP.getContext().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSP() {
        return FileUtil.deleteFilesInDir(MyAPP.getContext().getFilesDir().getParent() + File.separator + "shared_prefs");
    }
    ...
    public static boolean cleanExternalCache() {
        return SDCardUtil.isSDCardEnable() && FileUtil.deleteFilesInDir(MyAPP.getContext().getExternalCacheDir());
    }
